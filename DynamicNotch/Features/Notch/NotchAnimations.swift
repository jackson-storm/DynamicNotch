    ...
    static func preset(_ preset: NotchAnimationPreset) -> Self {
        ...
        case .snappy:
            return Self(
                ...
                openContentTransition: .spring(response: 0.31, dampingFraction: 0.8),
        ...
        case .fast:
            return Self(
                ...
                openContentTransition: .spring(response: 0.34, dampingFraction: 0.8),
        ...
        case .balanced:
            return Self(
                ...
                openContentTransition: .spring(response: 0.37, dampingFraction: 0.8),
